...
export class VillainGenerator {
	...
	public static generate() {
		const schemeObj: any = VillainGenerator.schemes[Math.floor(Math.random() * VillainGenerator.schemes.length)];
		let scheme = "";
		...
		const methodObj = VillainGenerator.methods[Math.floor(Math.random() * VillainGenerator.methods.length)];
		let method = "";
